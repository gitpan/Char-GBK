...
=head1 Un-Escaping \ of \N, \p, \P, and \X (GBK software provides)

GBK software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (GBK software provide)
...
=head1 Escaping File Test Operators (GBK software provide)
