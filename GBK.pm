...
my $qq_substr  = qr{(?: GBK::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
my $function_getc;        # getc    to getc    or GBK::getc
...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                my @list = eval $list;
                for (@list) {
                    $function_ord     = 'GBK::ord'     if /\A ord \z/oxms;
                    $function_ord_    = 'GBK::ord_'    if /\A ord \z/oxms;
                    $function_reverse = 'GBK::reverse' if /\A reverse \z/oxms;
                    $function_getc    = 'GBK::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }
...
# subroutines of package Egbk
    ...
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\3) /oxgc) { $slash = 'm//'; return "Egbk::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }
    ...
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\1|\\\\|$q_char)+?)    (\3) /oxgc) { $slash = 'm//'; return "Egbk::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)             (\") /oxgc)    { $slash = 'm//'; return "Egbk::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)             (\3) /oxgc)    { $slash = 'm//'; return "Egbk::$1(" . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\1|\\\\|$q_char)+?)    (\') /oxgc)    { $slash = 'm//'; return "Egbk::$1(" . e_q ('',  $2,$4,$3) . ")"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\1|\\\\|$q_char)+?)    (\3) /oxgc)    { $slash = 'm//'; return "Egbk::$1(" . e_q ('q', $2,$4,$3) . ")"; }
...
# subroutines of package Egbk
        ...
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\3) /oxgc) { $e_string .= "Egbk::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\1|\\\\|$q_char)+?)    (\3) /oxgc) { $e_string .= "Egbk::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\") ((?:$qq_char)+?)             (\") /oxgc)    { $e_string .= "Egbk::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)             (\3) /oxgc)    { $e_string .= "Egbk::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\1|\\\\|$q_char)+?)    (\') /oxgc)    { $e_string .= "Egbk::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\1|\\\\|$q_char)+?)    (\3) /oxgc)    { $e_string .= "Egbk::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                        1                                              2   3                                 4   5
                q<eval{local $GBK::re_t=%s; local $GBK::re_a=''; while($GBK::re_t =~ %s){%s local $^W=0; local $GBK::re_r=%s; %s$GBK::re_t="$GBK::re_a${1}$GBK::re_r$'"; pos($GBK::re_t)=length "$GBK::re_a${1}$GBK::re_r"; $GBK::re_a=substr($GBK::re_t,0,pos($GBK::re_t)); } return $GBK::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$GBK::re_r=eval $GBK::re_r; ' x $e_modifier,                  #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                        1                        2   3                                 4   5
                q<eval{local $GBK::re_t=%s; while($GBK::re_t =~ %s){%s local $^W=0; local $GBK::re_r=%s; %s$GBK::re_t="$`$GBK::re_r$'"; pos($GBK::re_t)=length "$`$GBK::re_r"; } return $GBK::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2          3                                 4   5  6                    7
                q<(%s =~ %s) ? eval{%s local $^W=0; local $GBK::re_r=%s; %s"%s$GBK::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<eval{local $GBK::re_n=0; local $GBK::re_a=''; while(%s =~ %s){%s local $^W=0; local $GBK::re_r=%s; %s%s="$GBK::re_a${1}$GBK::re_r$'"; pos(%s)=length "$GBK::re_a${1}$GBK::re_r"; $GBK::re_a=substr(%s,0,pos(%s)); $GBK::re_n++} return %s$GBK::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                 1     2   3                                 4   5 6                         7                                                 8
                q<eval{local $GBK::re_n=0; while(%s =~ %s){%s local $^W=0; local $GBK::re_r=%s; %s%s="$`$GBK::re_r$'"; pos(%s)=length "$`$GBK::re_r"; $GBK::re_n++} return %s$GBK::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3          4                                 5   6 7   8
                q<(%s%s%s) ? eval{%s local $^W=0; local $GBK::re_r=%s; %s%s="%s$GBK::re_r$'"; 1 } : undef> :

                #  1 2 3              4                                 5   6 7   8
                q<(%s%s%s) ? 1 : eval{%s local $^W=0; local $GBK::re_r=%s; %s%s="%s$GBK::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$GBK::re_r=eval $GBK::re_r; ' x $e_modifier,                  #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
expand wildcard arguments supplied to programs. Instead, import of Egbk.pm
works well.
...
=head1 Multiple-Octet Anchoring of Regular Expression (GBK.pm provides)
...
=head1 Escaping Second Octet (GBK.pm provides)
...
=head1 Multiple-Octet Character Regular Expression (GBK.pm provides)

GBK.pm clusters multiple-octet character with quantifier, makes cluster from
...
=head1 Calling 'Egbk::ignorecase()' (GBK.pm provides)
...
Definitions in Egbk.pm.
  ...
  ${Egbk::eS}             qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s])}
  ...
  ${Egbk::not_space}      qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\s\x0B])}
...
=head1 Un-Escaping \ of \N, \p, \P and \X (GBK.pm provides)

GBK.pm removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Un-Escaping bytes::* Subroutines (GBK.pm provides)

GBK.pm removes 'bytes::' at head of subroutine name.
