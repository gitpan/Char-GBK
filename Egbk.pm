...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Egbk::binmode(FILEHANDLE, $disciplines);
  Egbk::binmode(FILEHANDLE);
  Egbk::binmode($filehandle, $disciplines);
  Egbk::binmode($filehandle);

  * two arguments

  If you are using perl5.005 other than MacPerl, GBK software emulate perl5.6's
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Egbk::open(FILEHANDLE, $mode, $expr);
  $rc = Egbk::open(FILEHANDLE, $expr);
  $rc = Egbk::open(FILEHANDLE);
  $rc = Egbk::open(my $filehandle, $mode, $expr);
  $rc = Egbk::open(my $filehandle, $expr);
  $rc = Egbk::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Egbk::open($fh, ">logfile")     # $fh is autovivified
  ...
  Egbk::open my $fh, ">logfile" or die ...
  ...
  Egbk::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Egbk::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Egbk::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Egbk::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Egbk::open(FH, "<:crlf:encoding(GBK)", $path) or die "can't open $path: $!";
