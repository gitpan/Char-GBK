...
=item Make character
  ...
  set. For example, Egbk::chr(65) is "A" in either ASCII or GBK, not Unicode,
  and Egbk::chr(0x82a0) is a GBK HIRAGANA LETTER A. For the reverse of
  Egbk::chr, use GBK::ord.
