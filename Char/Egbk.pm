...
if (($] >= 5.010001) or
    ...
    if (__PACKAGE__ =~ / \b Egb18030 \z/oxms) {
        ${Char::Egbk::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[^\x30-\x39\x81-\xFE](?:[\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39]|[\x81-\xFE]{2})*?}oxms;
    }
...
=item Chop string
  ...
  character chopped. The Char::Egbk::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Egbk::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of GBK $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Egbk::fc function for case-insensitive comparisons via Char::GBK
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of GBK $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of GBK $string (or $_, if
...
=item Fold case string
  ...
  New to Char::GBK software, this function returns the full Unicode-like casefold of
  GBK $string (or $_, if omitted). This is the internal function implementing
...
=item File test function Char::Egbk::X
...
=item Filename expansion (globbing)
  ...
  The Char::Egbk::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Char::Egbk::stat, Char::Egbk::lstat, or Char::Egbk::stat-based file test function
