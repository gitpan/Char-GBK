...
=item Make character
  ...
  set. For example, Char::Egbk::chr(65) is "A" in either ASCII or GBK, not Unicode,
  and Char::Egbk::chr(0x82a0) is a GBK HIRAGANA LETTER A. For the reverse of
  Char::Egbk::chr, use Char::GBK::ord.
