...
my $m_matched   = '';
my $s_matched   = '';
$m_matched   = q{@Char::Egbk::m_matched};
...
=item * Handles Raw GBK, No UTF8 flag like JPerl
...
functions.
  ...
  y///B       tr///
  chop        Char::Egbk::chop
  index       Char::Egbk::index
  rindex      Char::Egbk::rindex
  lc          Char::Egbk::lc
  lcfirst     Char::Egbk::lcfirst
  uc          Char::Egbk::uc
  ucfirst     Char::Egbk::ucfirst
  chr         Char::Egbk::chr
  glob        Char::Egbk::glob
  lstat       Char::Egbk::lstat
  opendir     Char::Egbk::opendir
  stat        Char::Egbk::stat
  unlink      Char::Egbk::unlink
  chdir       Char::Egbk::chdir
  do          Char::Egbk::do
  require     Char::Egbk::require
  ---------------------------------
...
=item * Reverse List Or String
  ...
  %barfoo = Char::GBK::reverse(%foobar);
...
=item * Special Variables $` And $& Doesn't Function
  ...
  is escaped to
    'AAABBBCCC' =~ /\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?(?:BBB)@Char::Egbk::m_matched/;
