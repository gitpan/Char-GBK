...
10% everything else. But this "text" means US-ASCII text, and popular GBK
...
Perl3 or later can treat GBK.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::GBK software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw GBK, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Egbk.pm.
  ...
  ${Char::Egbk::not_space}      qr{(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20])}
...
Contrasting is Encode module and describing "use Char::GBK;" on this software,
