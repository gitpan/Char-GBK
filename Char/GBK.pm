...
=item * Only Char/GBK.pm and Char/Egbk.pm, other modules are unnecessary
...
Char/GBK.pm remove 'bytes::' at head of function name.
...
Char/GBK.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
oriented function. See 'CHARACTER ORIENTED FUNCTIONS'.
  ...
  index       Char::GBK::index
  rindex      Char::GBK::rindex
  ---------------------------------
